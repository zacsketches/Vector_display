...
public class Serial_listbox
{
    ...
    Serial_listbox ( float xx, float yy, float ww, float hh ) 
    {
        x = xx; y = yy;
        valueY = y;
        ...
        public boolean visible() {return vis;}
	public void set_visible(boolean val) {vis = val;}
